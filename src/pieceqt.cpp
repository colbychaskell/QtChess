...
PieceQt::PieceQt(const std::string& name, const Position& position, QGraphicsItem *parent) : QGraphicsPixmapItem(parent), name(name), position(position)
{
